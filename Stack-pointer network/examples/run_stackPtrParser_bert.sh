...
python examples/StackPointerParser.py --mode FastLSTM --num_epochs 200 --batch_size 32 --decoder_input_size 768 --hidden_size 768 --encoder_layers 1 --decoder_layers 1 \
 --pos --pos_dim 100 --char_dim 100 --num_filters 100 --arc_space 400 --type_space 400 \
 --opt adam --learning_rate 0.00002 --decay_rate 0.75 --epsilon 1e-4 --coverage 0.0 --gamma 0.01 --clip 1.0 \
 ...
 --pos_embedding 2 --pos_path "data/embedding/14_skipgram_100.vec" \
 --bert --bert_path "bert/" --bert_feature_dim 768 \
