...
python examples/StackPointerParser.py --mode FastLSTM --num_epochs 1 --batch_size 1 --decoder_input_size 256 --hidden_size 512 --encoder_layers 2 --decoder_layers 2 \
 ...
 --punctuation '.' '``' "''" ':' ',' \
 --train "data/sejong/toy_train.conllx" \
